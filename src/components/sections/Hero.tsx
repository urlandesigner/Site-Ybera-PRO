        ...
        <Container className="relative max-w-[1512px] lg:px-[100px]">
          ...
          <div className="flex w-full min-w-0 flex-1 flex-col gap-10 lg:gap-[72px]">
            <div className="flex flex-col gap-8">
              ...
              <div className="flex w-full max-w-[401px] flex-row flex-nowrap items-center gap-3">
                <button
                  type="button"
                  className="inline-flex shrink-0 cursor-pointer items-center justify-center gap-1 rounded-xl bg-white px-5 py-3 font-sans text-sm font-bold leading-[18px] text-[#1f6665] shadow-[0_1px_4px_0_rgba(5,5,5,0.1)] transition-[background-color,box-shadow,transform] hover:bg-[#eef8f7] hover:shadow-[0_2px_8px_0_rgba(5,5,5,0.12)] active:scale-[0.99]"
                >
                  Quero fazer parte do PRO
                </button>
                <button
                  type="button"
                  className="inline-flex shrink-0 cursor-pointer items-center justify-center gap-1 rounded-xl px-5 py-3 font-sans text-sm font-bold leading-[18px] text-white transition-[background-color,color] hover:bg-white/12 active:bg-white/18"
                >
                  Ver como funciona
                  <ArrowRightIcon />
                </button>
            ...
            <div className="flex w-full max-w-[500px] flex-wrap items-center gap-6 text-[#c2fffe]">
          ...
          <div className="relative w-full shrink-0 lg:w-[478px]">
            ...
            <CometCard className="relative z-[2] mx-auto w-full max-w-[440px] lg:mx-0">
