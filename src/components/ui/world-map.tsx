...
export default function WorldMap({
  ...
  return (
    <div className={cn("relative aspect-[2/1] w-full rounded-lg font-sans", className)}>
      {/* Opacidade só no mapa pontilhado (continentes); rotas/pontos ficam no SVG acima em opacidade total. */}
